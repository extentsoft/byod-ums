...
router.get('/devicemon', function(req,res,next){
  res.render('admin/devicemon', {title: 'Administrative Console - Devices Monitoring'});
});
router.get('/dashboard', function(req,res,next){
  res.render('admin/dashboard', {title: 'Administrative Console - Dashboard'});
});

router.get('/reportbyuser', function(req,res,next){
  res.render('admin/reports/reportbyuser', {title: 'Administrative Console - Users'});
});
///////////////////////////////////////////////////////////////////////////
