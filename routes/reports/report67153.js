...
var deviceList = function(req,res,next){
  ...
  pool.acquire(function(err, connection){
    ...
    var request = new Request("SELECT [browser],count(*) FROM [AgileControllerDB].[dbo].[UMS_AccessLog] where  [browser]!='undefined' and CONVERT (date, created_at) between '"+req.param('start')+"' and '"+req.param('end')+"' group by [browser]", function(err, rowCount){
