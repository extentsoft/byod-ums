...
var deviceList = function(req,res,next){
  ...
  pool.acquire(function(err, connection){
    ...
    var request = new Request("select * from (select top(100) * from [AgileControllerDB].[dbo].[UMS_Chat] order by created_at desc) as a order by a.created_at asc;", function(err, rowCount){
