...
var deviceList = function(req,res,next){
  ...
  pool.acquire(function(err, connection){
    ...
    var request = new Request("select [notification],[theme]  from [AgileControllerDB].[dbo].[UMS_UserPreference] where [user_ref] = '"+req.param('accname')+"'", function(err, rowCount){
