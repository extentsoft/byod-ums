...
var deviceList = function(req,res,next){
  ...
  pool.acquire(function(err, connection){
    ...
    var request = new Request("INSERT INTO [AgileControllerDB].[dbo].[UMS_AccessLog] ([browser],[ipaddr],[detail],[userId],[created_at]) VALUES ('"+req.param('browser')+"','"+req.param('ip')+"','"+req.param('status')+"','"+req.param('accname')+"',CURRENT_TIMESTAMP)", function(err, rowCount){
