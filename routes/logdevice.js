...
var deviceList = function(req,res,next){
  ...
  pool.acquire(function(err, connection){
    ...
    var request = new Request("INSERT INTO [AgileControllerDB].[dbo].[UMS_ActivityLog] ([detail],[userId],[devicemac],[created_at]) VALUES ('"+req.param('event')+"','"+req.param('teracc')+"','"+req.param('termac')+"',CURRENT_TIMESTAMP);", function(err, rowCount){
