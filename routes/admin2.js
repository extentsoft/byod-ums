module.exports = function(app, passport) {
    ...
    app.get('/sendCustSat/', function(req, res) {
        const mailOptions = {
            ...
            html: 'To valued staffs,<br><br>Please complete survey link to improve our service in the future <br> <a href="http://byod.home/custsat">Link</a><br><br>Thank you.<br><br>Administrator' // plain text body
        };
