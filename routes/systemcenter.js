        ...
        */
        ...
        Account.test(opts, function(err, user) {
            ...
            if (err instanceof Error) {
                ...
                request('http://byod.home/api/eoffice/profile/' + user.email, function(error, response, body) {
                    ...
                    if (!error && response.statusCode == 200) {
                        if (body != null) {
                            ...
                            request('http://byod.home/api/getuserpref?accname=' + user.email, function(error, response, body) {
                                if (!error && response.statusCode == 200) {
                                    if (body != null) {
