...
var deviceList = function(req, res, next) {
    ...
    pool.acquire(function(err, connection) {
        ...
        var request = new Request("DROP TABLE [AgileControllerDB].[dbo].[UMS_DPStaging]; SELECT * INTO [AgileControllerDB].[dbo].[UMS_DPStaging] from [AgileControllerDB].[dbo].[UMS_DPTemp];UPDATE [AgileControllerDB].[dbo].[UMS_DPStaging] SET [LAST_SYNC] = CURRENT_TIMESTAMP;", function(err, rowCount) {
