...
var deviceList = function(req,res,next){
  ...
  pool.acquire(function(err, connection){
    ...
    var request = new Request("SELECT count(*) FROM [AgileControllerDB].[dbo].[UMS_ActivityLog] where userId = 'natthawat_a' and CONVERT (date, created_at) = CONVERT (date, CURRENT_TIMESTAMP-3)", function(err, rowCount){
