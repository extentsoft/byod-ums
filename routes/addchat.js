...
var deviceList = function(req,res,next){
  ...
  pool.acquire(function(err, connection){
    ...
    var request = new Request("INSERT INTO [AgileControllerDB].[dbo].[UMS_Chat] ([name],[msg],[created_at])  VALUES ('"+req.param('usr')+"','"+req.param('msgchat')+"',current_timestamp)", function(err, rowCount){
