...
var deviceList = function(req,res,next){
  ...
  pool.acquire(function(err, connection){
    ...
    var request = new Request("SELECT [accountID],[account],[userName],[orgName] FROM [AgileControllerDB].[dbo].[TSM_E_Account] a join [AgileControllerDB].[dbo].[TSM_E_Organization] b on a.[orgID] = b.[orgID]", function(err, rowCount){
