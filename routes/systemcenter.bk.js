        ...
        Account.test(opts, function(err, user) {
            ...
            if (err instanceof Error) {
                ...
                /*
                                ...
                                request('http://192.168.163.29/api/eoffice/profile/' + Account.email, function(error, response, body) {
                                    ...
                                    if (!error && response.statusCode == 200) {
                                        if (body != null) {
                                            ...
                                            request('http://192.168.163.29/api/getuserpref?accname=' + Account.email, function(error, response, body) {
                                                if (!error && response.statusCode == 200) {
                                                    if (body != null) {
